function Description() {
  return (
    <div className="space-y-4 max-w-[70%] mx-auto my-16 bg-white px-8 py-10 rounded-lg shadow-xl">
      <h3 className="text-lg font-semibold text-center">Das Haus</h3>
      <p>
        ...
        Fahrrad in das nur 3 km entfernte Ostseebad zu radeln. Die Insel Rügen
      ...
      <p>
        Die ca. 30 m² große Wohnung verfügt über einen separaten Eingang und ist
        aufgeteilt in einem Wohn- Schlafraum, kleinem Flur, separater Küche
        sowie einem Badezimmer. Vor dem Eingang befindet sich eine kleine
        gemütliche Sitzecke und lädt zu einem Glas Wein zum Ausklang des Tages
        ein.
      </p>
      <h3 className="text-lg font-semibold text-center">Ausstattung</h3>
      <p>
        ...
        Tiefkühlfach, Kaffeemaschine, Toaster, Wasserkocher, Eierkocher,
